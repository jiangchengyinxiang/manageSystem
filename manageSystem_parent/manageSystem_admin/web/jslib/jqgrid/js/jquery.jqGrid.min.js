...
a=$.inArray(this.name,e.p.groupingView.groupField);a>=0&&e.p.groupingView.groupColumnShow.length>a&&(this.hidden=!e.p.groupingView.groupColumnShow[a])}this.widthOrg=b=A(this.width,0),!1===this.hidden&&(g+=b+h,this.fixed?l+=b+h:i++)}),isNaN(e.p.width)&&(e.p.width=g+(!1!==e.p.shrinkToFit||isNaN(e.p.height)?0:j)),f.width=parseInt(e.p.width,10),e.p.tblwidth=g+18,!1===e.p.shrinkToFit&&!0===e.p.forceFit&&(e.p.forceFit=!1),!0===e.p.shrinkToFit&&i>0&&(c=f.width-h*i-l,isNaN(e.p.height)||(c-=j,k=!0),g=0,$.each(e.p.colModel,function(d){!1!==this.hidden||this.fixed||(b=Math.round(c*this.width/(e.p.tblwidth-h*i-l)),this.width=b,g+=b,a=d)}),d=0,k?f.width-l-(g+h*i)!==j&&(d=f.width-l-(g+h*i)-j):k||1===Math.abs(f.width-l-(g+h*i))||(d=f.width-l-(g+h*i)),e.p.colModel[a].width+=d,e.p.tblwidth=g+d+h*i+l+18,e.p.tblwidth>e.p.width&&(e.p.colModel[a].width-=e.p.tblwidth-parseInt(e.p.width,10),e.p.tblwidth=e.p.width+18))},aa=function(a){var
